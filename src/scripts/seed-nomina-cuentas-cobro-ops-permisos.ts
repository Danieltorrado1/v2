...
const PERMISSIONS = [
  {
    modulo: 'nomina.cuentas_cobro_ops',
    accion: 'read',
    descripcion: 'Permiso base para nomina.cuentas_cobro_ops.read'
  },
  {
    modulo: 'nomina.cuentas_cobro_ops',
    accion: 'create',
    descripcion: 'Permiso base para nomina.cuentas_cobro_ops.create'
  },
  {
    modulo: 'nomina.cuentas_cobro_ops',
    accion: 'update',
    descripcion: 'Permiso base para nomina.cuentas_cobro_ops.update'
  },
  {
    modulo: 'nomina.cuentas_cobro_ops',
    accion: 'approve',
    descripcion: 'Permiso base para nomina.cuentas_cobro_ops.approve'
  },
  {
    modulo: 'nomina.cuentas_cobro_ops',
    accion: 'pay',
    descripcion: 'Permiso base para nomina.cuentas_cobro_ops.pay'
  }
] as const;
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('Nomina cuentas de cobro OPS permissions seeded successfully.');
  } catch (error) {
    await client.query('ROLLBACK');
    console.error('Nomina cuentas de cobro OPS permissions seed failed.');
    console.error(error);
    process.exitCode = 1;
  } finally {
    client.release();
