...
const PERMISSIONS = [
  {
    modulo: 'evaluaciones',
    accion: 'read',
    descripcion: 'Permiso base para evaluaciones.read'
  },
  {
    modulo: 'evaluaciones',
    accion: 'write',
    descripcion: 'Permiso base para evaluaciones.write'
  },
  {
    modulo: 'evaluaciones',
    accion: 'dashboard',
    descripcion: 'Permiso base para evaluaciones.dashboard'
  },
  {
    modulo: 'evaluaciones',
    accion: 'dashboard_general',
    descripcion: 'Permiso base para evaluaciones.dashboard_general'
  },
  {
    modulo: 'evaluaciones.planes_mejora',
    accion: 'read',
    descripcion: 'Permiso base para evaluaciones.planes_mejora.read'
  },
  {
    modulo: 'evaluaciones.planes_mejora',
    accion: 'write',
    descripcion: 'Permiso base para evaluaciones.planes_mejora.write'
  },
  {
    modulo: 'evaluaciones.planes_mejora',
    accion: 'dashboard',
    descripcion: 'Permiso base para evaluaciones.planes_mejora.dashboard'
  },
  {
    modulo: 'evaluaciones.planes_mejora',
    accion: 'alertas',
    descripcion: 'Permiso base para evaluaciones.planes_mejora.alertas'
  }
] as const;
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('Evaluaciones permissions seeded successfully.');
  } catch (error) {
    await client.query('ROLLBACK');
    console.error('Evaluaciones permissions seed failed.');
    console.error(error);
    process.exitCode = 1;
  } finally {
    client.release();
