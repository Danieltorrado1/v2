...
const PERMISSIONS = [
  {
    modulo: 'nomina.intereses_cesantias',
    accion: 'read',
    descripcion: 'Permiso base para nomina.intereses_cesantias.read'
  },
  {
    modulo: 'nomina.intereses_cesantias',
    accion: 'write',
    descripcion: 'Permiso base para nomina.intereses_cesantias.write'
  },
  {
    modulo: 'nomina.intereses_cesantias',
    accion: 'dashboard',
    descripcion: 'Permiso base para nomina.intereses_cesantias.dashboard'
  },
  {
    modulo: 'nomina.intereses_cesantias',
    accion: 'alertas',
    descripcion: 'Permiso base para nomina.intereses_cesantias.alertas'
  }
] as const;
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('Nomina intereses cesantias permissions seeded successfully.');
  } catch (error) {
    await client.query('ROLLBACK');
    console.error('Nomina intereses cesantias permissions seed failed.');
    console.error(error);
    process.exitCode = 1;
  } finally {
    client.release();
