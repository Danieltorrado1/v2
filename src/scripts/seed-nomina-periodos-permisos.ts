...
const PERMISSIONS = [
  {
    modulo: 'nomina.periodos',
    accion: 'pay',
    descripcion: 'Permiso base para nomina.periodos.pay'
  },
  {
    modulo: 'nomina.periodos',
    accion: 'reopen',
    descripcion: 'Permiso base para nomina.periodos.reopen'
  },
  {
    modulo: 'nomina.periodos',
    accion: 'cancel',
    descripcion: 'Permiso base para nomina.periodos.cancel'
  },
  {
    modulo: 'nomina.dashboard',
    accion: 'read',
    descripcion: 'Permiso base para nomina.dashboard.read'
  },
  {
    modulo: 'nomina.plano_bancario',
    accion: 'export',
    descripcion: 'Permiso base para nomina.plano_bancario.export'
  },
  {
    modulo: 'nomina.planilla_pdf',
    accion: 'generate',
    descripcion: 'Permiso base para nomina.planilla_pdf.generate'
  },
  {
    modulo: 'nomina.recargos',
    accion: 'create',
    descripcion: 'Permiso base para nomina.recargos.create'
  }
] as const;
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('Nomina period permissions seeded successfully.');
  } catch (error) {
    await client.query('ROLLBACK');
    console.error('Nomina period permissions seed failed.');
    console.error(error);
    process.exitCode = 1;
  } finally {
    client.release();
