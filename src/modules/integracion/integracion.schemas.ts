...
export const integracionListQuerySchema = z.object({
  ...
  event_type: z.enum(['VINCULACION_ACTUALIZADA','VINCULACION_RETIRADA','ASIGNACION_OPERATIVA_CAMBIADA','CONDICION_PENSION_CAMBIADA']).optional(), status: z.enum(['PENDIENTE','PROCESANDO','PROCESADO','ERROR']).optional(),
