  ...
  return {
    ...
    sql: `
      SELECT
        ...
        CASE WHEN dp.metadatos_revision->>'manipulacion_modalidad'='COMBINADO' THEN 'Manipulación: Curso + Exámenes' ELSE td.nombre_documento END AS nombre_tipo_documento,
  ...
  return {
    ...
    sql: `
      SELECT
        ...
        CASE WHEN dv.metadatos_revision->>'manipulacion_modalidad'='COMBINADO' THEN 'Manipulación: Curso + Exámenes' ELSE td.nombre_documento END AS nombre_tipo_documento,
